...
{
    public class RemoveApproveVacationManagerTest
    {
        ...
        [Test]
        public async Task TestRemoveVacationRequestQueue()
        {
            string messageId = "43187a16-6fcf-43ff-9f6d-eaaed4ec341c";
            RemoveApproveVacationManager removeApproveVacationManager = new RemoveApproveVacationManager(_httpClient);

            var actualresult = await removeApproveVacationManager.RemoveApprovedVacation(messageId);
